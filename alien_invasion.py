...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        # Start new game if the play button is clicked
    ...
    def _fire_bullet(self):
        # Limit the number of bullets allowed
    ...
    def _create_fleet(self):
        ...
        # Determine number of aliens that can fit on screen
        available_space_x = self.settings.screen_width - (2 * alien_width)
        number_aliens_x = available_space_x // (2 * alien_width)

        # Determine the number of rows of aliens can fit on screen
